  ...
  <!-- global variables and functions -->
			...
			<body>
				...
				<div id="footer">
                                    ...
                                    <ul>
                                      ...
                                      <li><a href="http://science.energy.gov/bes/">Director, Office of Science, Office of Basic Energy Sciences</a>, of the U.S. Department of Energy under Contract No. DE-AC02-05CH11231.</li>
                                      <li><a href="http://www.scotland.gov.uk/Topics/Research/About/EBAR">Scottish Government Rural and Environmental Research and Analysis Directorate</a></li>
		...
		<table id="header">
			<tr>
				...
				<td id="menu">
					...
					&#183; <!-- middot -->
					<a href="http://biohackathon.org/resource/faldo.rdf">RDF/XML</a>
                                        &#183; <!-- middot -->
	...
	<xsl:template name="url">
		...
		<xsl:choose>
			...
			<xsl:when test="$ns='&faldo;'">
				<a href="{concat($ns,$name)}">
					faldo:<xsl:value-of select="$name" />
				</a>
			</xsl:when>
	...
	<xsl:template name="prettyUrl">
		...
		<xsl:choose>
			...
			<xsl:when test='starts-with($name, "&faldo;")'>
				faldo:<xsl:value-of select='substring-after($name, "&faldo;")' />
			</xsl:when>
